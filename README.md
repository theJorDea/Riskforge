...
- [x] Ноутбук 01: EDA стилизованных фактов (жирные хвосты, кластеризация)
- [x] Ноутбук 02: сравнение трёх методов VaR на реальном портфеле + вердикты бэктестов
- [x] Ноутбук 03: EWMA vs GARCH в прогнозе волатильности (вкл. честный негативный результат: GARCH-VaR с гауссовым квантилем не проходит Купика — нужен t-квантиль)
- [x] Выводы и ограничения моделей по результатам на реальных данных (в ноутбуках)
